...
date = '2021-12-24'
outdir = '../../sim_data/Soummyadip_1/ff_data/'
...
for arg in sys.argv[1:]:
    ...
    runtag = '%s_%s_plawidx_%.2f_zsmax_%.1f_y0_%.1f_%s_%s_Nsim_%.0e_lw' %(zs_dist[node],
                                        approx, mass_dist_pwl_index, zs_max, y0, psd_model[node], date, N_sim)
    simfname = '../../sim_data/Soummyadip_1/astro_sim_data/machodm_lensing_astro_sim_%s' %(runtag)
